...
public class ClassFileParserTest {
    ...
    public void parseObjectClass() {
        ...
        List<String> realMethods = Arrays.stream(clazz.getMethods())
                .map(m -> m.getDescriptor() + " " + m.getName() + " " + m.getArgc() + " " + m.getMaxLocal() + " "
                        + m.getMaxStack())
    ...
    public void parseStringClass() {
        ...
        // interface name
        String[] expectedInterfaces = new String[] { "java/io/Serializable", "java/lang/Comparable",
        ...
        JClass clazz = new JClass(classfile);
        // field name
        String[] expectedFields = new String[] { "value", "hash", "serialVersionUID", "serialPersistentFields",
